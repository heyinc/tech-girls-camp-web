...
## わからない箇所を Claude Code に聞いてみる

ここまで書いてきたHTMLやCSSの中で、意味がよくわからないタグや書き方があれば、セットアップ章で起動した Claude Code に質問してみましょう。

たとえばこんな質問ができます。

```
<link rel="stylesheet"> ってどういう意味？
```

```
index.html を読んで、それぞれのタグが何をしているか日本語で説明して
```

後者のように `index.html を読んで` と伝えると、Claude Code は実際に手元のファイルを開いてその内容に沿って答えてくれます。

コードを読むときの相棒として、わからない部分があれば気軽に質問してみてください。
